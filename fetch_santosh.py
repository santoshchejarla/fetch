...
class transaction:
    ...
    def load_data(self, file_name="transactions.csv") -> None:
        """loads the transaction data and populates required data structures with values
    ...
    def solve(self) -> dict:
        ...
        for payer in self.payers:
            total_funds += sum(self.payers[payer])
...
def main():
    try:
        ...
        if amount < 0:
            ...
            print(json.dumps(transaction_obj.solve(), indent=4))
    except:
